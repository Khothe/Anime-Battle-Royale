...
public class VentanaGrafica extends JFrame implements WindowListener{	
	...
	/** Visualiza un mensaje enf la línea de mensajes
 ...
 */
	...
	public void esperaAEvento( int msg ) {
		...
		while (sigoEsperando && System.currentTimeMillis() < esperaHasta) {
			...
			if (sigoEsperando)
				// Espera hasta que el ratón haga algo
				try {
					Thread.sleep(10);
				} catch (InterruptedException e) { }
		}
	...
	//método y atributos privados para facilitar los offsets de puntos
		...
		public static void main(String[] args) {
			...
			if (!pruebaConDrag) {
				// PRUEBA SIN DRAG
				VentanaGrafica v = new VentanaGrafica(1000, 563, 0, false, true, false, "Ventana gráfica de prueba" );
